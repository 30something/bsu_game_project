...
constexpr int kMenuWidth = 800;
constexpr int kMenuHeight = 800;
constexpr int kMenuSpacing = 16;
constexpr int kMenuMinButtonWidth = kMenuWidth * 3 / 8;
constexpr int kMenuMinButtonHeight = kMenuHeight / 7;
constexpr int kPauseMenuWidth = 500;
